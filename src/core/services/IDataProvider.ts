import { Message, Conversation, Category, Subcategory, Context, ProviderModel, ModelProvider, SearchResult } from '../../types';
import {
    SendMessageParams,
    MessageResponse,
...
export interface IDataProvider {
    ...
    createConversation(params: { model: string; subcategoryId?: number }): Promise<Conversation>;
    deleteConversation(id: number): Promise<void>;
    renameConversation(params: { id: number; title: string }): Promise<void>;
    moveConversation(params: { id: number; subcategoryId: number | null }): Promise<void>;
    ...
    toggleProviderModel(params: { id: string; isEnabled: boolean }): Promise<boolean>;
    updateProvider(params: { id: string; apiKey: string | null; isActive: boolean }): Promise<boolean>;
    ...
    updateContextItem(params: { id: number; content: string; subcategoryId: number | null }): Promise<void>;
