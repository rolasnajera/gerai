...
const DeleteCategoryModal: React.FC<DeleteCategoryModalProps> = ({
    ...
    const isConfirmed = confirmName.trim() === categoryName.trim();
            ...
            <div className="bg-white dark:bg-gray-900 rounded-xl shadow-xl w-full max-w-md overflow-hidden flex flex-col">
                <div className="p-6 space-y-4">
                    ...
                    <p className="text-gray-600 dark:text-gray-400">
                        Are you sure you want to delete <span className="font-bold text-gray-900 dark:text-gray-100">"{categoryName}"</span>?
                        This action CANNOT be undone. <span className="font-bold text-red-600 dark:text-red-400">ALL subcategories and conversations</span> within this category will be permanently removed.
                    </p>

                    <div className="space-y-2">
                        <label className="text-sm font-medium text-gray-700 dark:text-gray-300">
                            Type <span className="font-mono bg-gray-100 dark:bg-gray-800 px-1 rounded">{categoryName}</span> to confirm:
                        </label>
                        <input
                            autoFocus
                            type="text"
